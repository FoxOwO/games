    ...
    private Optional<List<Game>> getGames(List<Game> games, PreparedStatement preparedStatement) throws SQLException {
        ...
        while (resultSet.next()){
            games.add( Game.builder()
                    ...
                    .year_edition(resultSet.getInt("year_edition"))
                    .age(resultSet.getString("age"))
                    .minPlayers(resultSet.getInt("min_players"))
                    .maxPlayres(resultSet.getInt("max_players"))
                    .category_id(resultSet.getInt("category_id"))
                    .duration(resultSet.getString("play_duration"))
                    .difficulty_id(resultSet.getInt("difficulty_id"))
